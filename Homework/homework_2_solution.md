...
`
file variable is defined as :
    file: "{{inputs.taxi}}_tripdata_{{inputs.year}}-{{inputs.month}}.csv"
in our case, inputs.taxi = 'green', inputs.year = 2020,
inputs.month = 04
`
...
`Answer: Add location perperty and set to America/New_York`
![HW2-6](./images/HW2-6.png)
