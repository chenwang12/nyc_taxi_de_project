...
`The database will resolve to myproject because the environment variable DBT_BIGQUERY_PROJECT is set to "myproject"; The table name remains as specified: ext_green_taxi; DBT_BIGQUERY_SOURCE_DATASET use the default value "raw_nyc_tripdata" `
...
`Answer: Update the WHERE clause to `pickup_datetime >= CURRENT_DATE - INTERVAL '{{ env_var("DAYS_BACK", "30") }}' DAY`
...
`Answer: green: {p97: 55.0, p95: 45.0, p90: 26.5}, yellow: {p97: 32, p95: 26, p90: 19.0} `

![image](./images/HW4-6.png)
