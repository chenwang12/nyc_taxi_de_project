...
Partitioning the table by tpep_dropoff_datetime and clustering on VendorID significantly reduces the amount of data scanned, resulting in lower estimated bytes processed.
`
...
`Answer: GCP Bucket. The data remains in its original location(GCP Bucket), and BigQuery simply references it.`
